...
def main():
    ...
    vid = cv2.VideoCapture('/Users/guojun/Workspace/data/server_slam/drone_orin/video/orin.mp4')
    ...
    while vid.isOpened():
        ...
        if ret:
            ...
            results = request_service('http://172.29.249.77:50001/api', user, 'stream', ['slam'], time.time(), frame)
            if len(results) > 0:
